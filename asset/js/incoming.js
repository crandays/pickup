            ...
            <div className="row no-margin">
                <div className="col-md-12">
                    <form method="POST" action="provider/profile/available">
                        ...
                        <button type="submit" className="full-primary-btn fare-btn">ÊTRE HORS LIGNE</button>
                    </form>
                </div>
            </div>
        );
            ...
            <div className="row no-margin">
                <div className="col-md-12">
                    <form method="POST" action="provider/profile/available">
                        ...
                        <button type="submit" className="full-primary-btn fare-btn">ÊTRE EN LIGNE</button>
                    </form>
                </div>
            </div>
        );
