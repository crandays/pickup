                ...
                <table class="table table-striped table-bordered dataTable" id="table-2">
                    ...
                    @foreach($providers as $index => $provider)
                        ...
                        <tr>
                            ...
                            <td>{{ $provider->loyality_points }}</td>
                            ...
                            <td>
                                ...
                                @if($provider->pending_documents() > 0 || $provider->service == null)
                                    ...
                                    <a class="btn btn-danger btn-block label-right" href="{{route('admin.provider.document.index', $provider->id )}}">Attention! <span
                                ...
                                <div class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ route('admin.provider.request', $provider->id) }}" class="btn btn-default"><i class="fa fa-search"></i>
                                                History</a>
                                        ...
                                        <li>
                                            ...
                                            <a class="btn btn-default" onclick="updateWallet({{$provider->wallet_balance}},{{$provider->id}})"><i
                                                        class="fa fa-pencil"></i>Add to wallet</a>

                                        </li>

                                        <li>

                                            <a href="{{ route('admin.provider.statement', $provider->id) }}" class="btn btn-default"><i class="fa fa-account"></i>
                                                Statements</a>
                                        ...
                                        <li>
                                            ...
                                            <a href="{{ route('admin.provider.payments', $provider->id) }}" class="btn btn-default"><i class="fa fa-account"></i>Payments
                                                Reports</a>
