...
{{--                <div class="form-group row">--}}
{{--                    <label for="mobile" class="col-xs-2 col-form-label">Provider Wallet Balance</label>--}}
{{--                    <div class="col-xs-10">--}}
{{--                        <input class="form-control" type="text" value="{{ $provider->wallet_balance }}" name="wallet_balance" required id="wallet_balance"--}}
