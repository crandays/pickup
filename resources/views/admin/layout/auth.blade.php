...
<head>
    ...
    <!-- Title -->
    <title>{{ Setting::get('site_title', 'PickUp') }}</title>
...
<body>
    ...
    <?php $background = asset('main/assets/img/photos-1/2.webp'); ?>

    <body class="img-cover" style="background-image: url(/main/assets/img/photos-1/2.webp);">
