...
Route::get('/ProviderTransactionHistory', 'ProviderResources\ProfileController@ProviderTransactionHistory')->name('ProviderTransactionHistory');
...
Route::group(['middleware' => ['provider.api']], function () {
    ...
    Route::group(['prefix' => 'profile'], function () {
        ...
        Route::post('/deductFromWallet', 'ProviderResources\ProfileController@deductFromWallet');
