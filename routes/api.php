...
Route::post('/loyality_gifts' , 'UserApiController@loyalityGifts');
Route::get('/user-loyality-gifts/{type}/{id}' , 'UserApiController@userLoyalityGifts')->where('type', '1|2')->where('id', '[0-9]+');
Route::get('/purchase-loyality-gifts/{type}/{id}/{gift_id}' , 'UserApiController@purchaseLoyalityGifts')->where('type', '1|2')->where('id', '[0-9]+')->where('gift_id', '[0-9]+');
