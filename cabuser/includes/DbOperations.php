     ...
     public function getcity(){
       ...
       public function getverification(){
        ...
        public function updateservice($sid, $pid){
           $stmt = $this->con->prepare("INSERT INTO provider_services (id, provider_id, service_type_id, status, service_number, service_model, service_color, created_at, updated_at) VALUES (NULL, ?, ?, 'active', '', '', '', '', '');");
